...
void loop() {
  ...
  int ident = 4;                           // change to unique identity number for each sensor
  doc_to_espnow["v4"] = temp;                       // Creating JSON data. Here { v1 : 28.55 }
  doc_to_espnow["v5"] = hum;                       // Creating JSON data. Here { v2 : 34.35 }
  doc_to_espnow["v6"] = ident; 
